...
CREATE INDEX IF NOT EXISTS meal_attendance_date_idx ON meal_attendance(menu_date, meal_type);
...
CREATE INDEX IF NOT EXISTS meal_feedback_date_idx ON meal_feedback(menu_date, meal_type);
